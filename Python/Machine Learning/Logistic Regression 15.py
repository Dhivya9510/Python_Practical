...
# Own notes: In independent variable, we need to reshape it into a column from a row for the LogisticRegression() function to work.
            # Go through the codes for Logistic Regression. It has co-ef code & Probability codes also in it. 
